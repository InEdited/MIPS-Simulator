...
public class Processor {
    ...
    public Mux aluSrcMux,memToRegMux,pcBranchMux,pcBranchJumpMux,regDstMux,jalMux,jrMux;
    public ALU alu;
    ...
    public void singleCycle(){
        ...
        regWriteDataTany = jrMux.mux(regWriteData,Integer.toBinaryString(pcIncremented),jrFlag);
        registerFile.writeRegister(registerWrite,regWriteDataTany);
